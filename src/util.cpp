...
const char * const BITCOIN_CONF_FILENAME = "bitau.conf";
const char * const BITCOIN_PID_FILENAME = "bitau.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bitau";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bitau";
#else
    // Unix
    return pathRet / ".bitau";
#endif
#endif
}
