...
{
    const char* pszTimestamp = "BBC World 14/Mar/2021 Bitcoin surges past USD61000 for first time";
    const CScript genesisOutputScript = CScript() << ParseHex("060934710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b09a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1615734352, 2085658823, 0x1e0ffff0, 1, 24 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x49d0ced34d2ecadca13075bb0ec45995f44db6bc3e132fd121bfeb3f20f69173"));
        assert(genesis.hashMerkleRoot == uint256S("0xaf832f205c3ec218fa1d202e2aa060aea550bcd08139980219921948b713514c"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("165.22.199.223", "165.22.199.223", true));
        vSeeds.push_back(CDNSSeedData("172.105.109.166", "172.105.109.166", true));
        vSeeds.push_back(CDNSSeedData("loyalblood.ca", "dnsseed.loyalblood.ca", true));
        vSeeds.push_back(CDNSSeedData("bitau.co", "dnsseed.bitau.co"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x7300afd3c21de386a36f70e4ed16b0621db35a75b23573743ec507fe6948eba8"))
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1615734352, 3717269, 0x1e0ffff0, 1, 24 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xde5cc23d5bc7dc00386461b14bb1047a7330660811e16e9e4a23e8d012cc6f29"));
        assert(genesis.hashMerkleRoot == uint256S("0xaf832f205c3ec218fa1d202e2aa060aea550bcd08139980219921948b713514c"));
        ...
        vSeeds.push_back(CDNSSeedData("172.105.109.166", "172.105.109.166", true));
        vSeeds.push_back(CDNSSeedData("loyalblood.ca", "testnet.loyalblood.ca", true));
        vSeeds.push_back(CDNSSeedData("bitau.co", "testnet.bitau.co"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xde5cc23d5bc7dc00386461b14bb1047a7330660811e16e9e4a23e8d012cc6f29")),
        };
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x32d907262f6a8d9c8a23ed3e14b164218b101c8852a102895329f863f443cc3d"));
        assert(genesis.hashMerkleRoot == uint256S("0xaf832f205c3ec218fa1d202e2aa060aea550bcd08139980219921948b713514c"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x32d907262f6a8d9c8a23ed3e14b164218b101c8852a102895329f863f443cc3d"))
        };
