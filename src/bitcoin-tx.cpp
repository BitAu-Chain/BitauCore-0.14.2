...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitau-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitau-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitau transaction") + "\n" +
              "  bitau-tx [options] -create [commands]   " + _("Create hex-encoded bitau transaction") + "\n" +
              "\n";
